...
import com.ymg.sample.presentation.ui.holder.StorageViewHolder
...
class StorageAdapter : ListAdapter<Media, StorageViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StorageViewHolder {
        return StorageViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.fragment_storage_item,
                parent,
                false
            ),
            _clickItemEvent
