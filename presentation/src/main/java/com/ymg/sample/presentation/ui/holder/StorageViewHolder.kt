...
import com.ymg.sample.presentation.databinding.FragmentStorageItemBinding
...
class StorageViewHolder (
    ...
    val binding: FragmentStorageItemBinding = DataBindingUtil.bind(view) ?: throw IllegalStateException()
